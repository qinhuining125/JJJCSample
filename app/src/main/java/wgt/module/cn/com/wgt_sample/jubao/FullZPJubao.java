 ...
 */
public class FullZPJubao extends Dialog {
...
//    private List<List<PersonEntity.PersonSonEntity>> personSonList;
    ...
    public FullZPJubao(Context context, String text, List<JubaopersonEntity> personList) {
        super(context);
        this.text = text;
...
//        }
    ...
    private void optionsPick(final TextView et, final List<JubaopersonEntity> dataList) {
...
//                receiveId = dataSonList.get(options1).get(option2).getUserId();
    ...
    private List getData() {
        ...
        for (int i = 0; i < 10; i++) {
//            list.add("数据" + i);
//            list.add(new JubaopersonEntity("1","巡查一组"));
//            list.add(new JubaopersonEntity("1","巡查一组"));
//            list.add(new JubaopersonEntity("1","巡查一组"));
