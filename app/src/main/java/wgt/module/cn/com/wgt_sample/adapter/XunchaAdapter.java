 ...
 */
public class XunchaAdapter extends BaseAdapter<XunchaAdapter.ViewHolder> {
    ...
    public XunchaAdapter(List<TaskEntity.TaskSonEntity> list, Context context) {
        super(context);
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        switch (data.getState()) {
            case 0:
                // 当状态为0，0未处理，1已受理，2已完结，3已指派
                // 新建指派和当前登录用户一致时，显示审批按钮。
