...
public class JubaoMessageActivity_ViewBinding<T extends JubaoMessageActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public JubaoMessageActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    target.layoutFlows = Utils.findRequiredViewAsType(source, R.id.layout_flows, "field 'layoutFlows'", LinearLayout.class);
    target.layoutFlowsRecyclerView = Utils.findRequiredViewAsType(source, R.id.layout_flows_recycler, "field 'layoutFlowsRecyclerView'", RecyclerView.class);
  ...
  public void unbind() {
    ...
    target.layoutFlows = null;
    target.layoutFlowsRecyclerView = null;
