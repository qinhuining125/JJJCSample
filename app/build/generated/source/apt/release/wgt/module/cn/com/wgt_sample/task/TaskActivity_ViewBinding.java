...
public class TaskActivity_ViewBinding<T extends TaskActivity> implements Unbinder {
  ...
  @UiThread
  public TaskActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    target.taskFinishtasktext = Utils.findRequiredViewAsType(source, R.id.task_finishtasktext, "field 'taskFinishtasktext'", TextView.class);
    target.taskFinishtaskline = Utils.findRequiredView(source, R.id.task_finishtaskline, "field 'taskFinishtaskline'");
    ...
    view = Utils.findRequiredView(source, R.id.task_add, "field 'taskAdd' and method 'onViewClicked'");
    target.taskAdd = Utils.castView(view, R.id.task_add, "field 'taskAdd'", ImageView.class);
    view2131296674 = view;
    ...
    view = Utils.findRequiredView(source, R.id.task_finishtask, "field 'taskFinishtask' and method 'onViewClicked'");
    target.taskFinishtask = Utils.castView(view, R.id.task_finishtask, "field 'taskFinishtask'", RelativeLayout.class);
    view2131296683 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
  ...
  public void unbind() {
    ...
    target.taskFinishtasktext = null;
    target.taskFinishtaskline = null;
