...
public class JubaoAdapter$ViewHolder_ViewBinding<T extends JubaoAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public JubaoAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
