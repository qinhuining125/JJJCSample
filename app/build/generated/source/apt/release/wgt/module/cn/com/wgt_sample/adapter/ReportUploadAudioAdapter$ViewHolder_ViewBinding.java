...
public class ReportUploadAudioAdapter$ViewHolder_ViewBinding<T extends ReportUploadAudioAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public ReportUploadAudioAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
