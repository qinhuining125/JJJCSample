...
public class XunchaAdapter$ViewHolder_ViewBinding<T extends XunchaAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public XunchaAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
