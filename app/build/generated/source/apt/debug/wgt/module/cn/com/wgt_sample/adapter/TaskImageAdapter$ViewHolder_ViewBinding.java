...
public class TaskImageAdapter$ViewHolder_ViewBinding<T extends TaskImageAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public TaskImageAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
