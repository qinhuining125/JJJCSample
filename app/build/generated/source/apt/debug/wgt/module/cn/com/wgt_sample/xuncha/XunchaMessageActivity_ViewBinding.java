...
public class XunchaMessageActivity_ViewBinding<T extends XunchaMessageActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public XunchaMessageActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    target.imageQRcode = Utils.findRequiredViewAsType(source, R.id.task_QRcode, "field 'imageQRcode'", ImageView.class);
    view = Utils.findRequiredView(source, R.id.save_QRcode, "field 'btSaveQRcode' and method 'onViewClicked'");
    target.btSaveQRcode = Utils.castView(view, R.id.save_QRcode, "field 'btSaveQRcode'", TextView.class);
    view2131296602 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    target.layoutQrcode = Utils.findRequiredViewAsType(source, R.id.layout_qrcode, "field 'layoutQrcode'", LinearLayout.class);
  ...
  public void unbind() {
    ...
    target.imageQRcode = null;
    target.btSaveQRcode = null;
    target.layoutQrcode = null;
